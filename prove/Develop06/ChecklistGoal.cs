...
public class ChecklistGoal : Goal
{
    ...
    public override void CreateChildGoal()
    {
        ...
        Console.Write("How many times does this goal need to be accomplished for a bonues? ");
    ...
    {
        string line = "";
        line = $"ChecklistGoal:" + _name + "," + _description + "," + _goalPoints.ToString() + "," + _steps.ToString() + "," + _stepCounter.ToString();
        return line;
    }
}